...
def get_data(pageNo,q):  
    ...
    r = requests.get(url+str(pageNo), headers=headers)#, proxies=proxies)
    content = r.content
...
if __name__ == "__main__":
    ...
    p = {}
    if sys.argv in ['t', 'p']: # user decides which method to invoke: thread, process or pool
    ...
    df = pd.DataFrame({'Title':products, 'Price':prices, 'Ratings':ratings})
    print(df)
